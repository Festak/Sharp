    ...
    public partial class WTF : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Tag_Id, t.Offer_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TagOffers", "Offer_Id", "dbo.Offers");
            DropForeignKey("dbo.TagOffers", "Tag_Id", "dbo.Tags");
            DropForeignKey("dbo.Offers", "Book_Id", "dbo.Books");
            DropForeignKey("dbo.Books", "Genre_Id", "dbo.Genres");
            DropForeignKey("dbo.BookAuthors", "Author_Id", "dbo.Authors");
            DropForeignKey("dbo.BookAuthors", "Book_Id", "dbo.Books");
            DropIndex("dbo.TagOffers", new[] { "Offer_Id" });
            DropIndex("dbo.TagOffers", new[] { "Tag_Id" });
